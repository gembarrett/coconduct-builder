  ...
  var content = `
    <div id="intro" class="nav-start contain">
      ...
      <div class="btn-wrap wrap-c">
        ...
        <div class="btns">
          <div><button class="btn btn-prim" id="submit-home-event" onclick="signPosts('ev', 'h')">`+buttons[0].name+`</button><p>`+buttons[0].desc+`</p></div>
          <div><button class="btn btn-seco" id="submit-home-project" onclick="signPosts('pr', 'h')">`+buttons[1].name+`</button><p>`+buttons[1].desc+`</p></div>
        </div>
        </div>
      </div>
    </div>
